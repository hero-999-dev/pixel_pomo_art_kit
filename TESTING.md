...
**168 tests, all passing.** Verified 2026-09-17 on `main`, Windows 11, Python
3.14.4, Tk 8.6, Pillow 12.2.0, `PIXEL_POMO_TOOLS` unset (i.e. against the
sibling game checkout the kit resolves relatively,
`..\App\flutter\tools\gen_objects.py`). About 80 s wall clock, almost all of
it the 46 smoke tests each building the whole window. Nothing in the suite
