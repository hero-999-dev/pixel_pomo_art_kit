...
**364 tests, all passing.** Verified 2026-09-23 on `main` (v2.8.0 in progress),
...
`..\App\flutter\tools\gen_objects.py`). About 235 s wall clock, almost all of
it the 168 smoke tests each building the whole window. Nothing in the suite
